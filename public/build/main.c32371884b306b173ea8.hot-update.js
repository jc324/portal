...
const FinishedProductsStep = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core__WEBPACK_IMPORTED_MODULE_2__["Box"], {
    ...
    message: "Provide documented information pertaining to all raw materials (RM's) related to the halal products in consideration.\r All of the following items are considered raw materials:\r Any ingredients used to produce the halal product.\r Packaging material that comes into direct contact with the halal product.\r Cleaning agents used to sanitize production tools, utensils, or surfaces that are in direct contact with the halal product.\r Feed for livestock, or any living creatures related to the halal product.\r You will be prompted to provide the following additional information:\r The correlating raw material manufacturer (RMM). RMM\u2019s are the producers of the ingredients that make up the halal product. This may not be the same as the company supplying the product to your facility.\r Halal Certificates/Disclosure Statements. All RMM\u2019s must be halal certified, or provide a halal disclosure statement which can be downloaded by clicking the 'Download Halal Disclosure Statement' button. The Halal disclosure statement is a written testimony that the RM\u2019s used in the halal product do not come into contact with, and do not contain contaminants (See disclosure statement template for the full list of contaminants).\r *Note: Items such as lettuce, tomatoes, and onions that have not been processed or altered do not require halal disclosure statements.",
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 84,
...
//# sourceMappingURL=main.c32371884b306b173ea8.hot-update.js.map